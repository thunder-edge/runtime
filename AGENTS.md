...
3. Web standards report is up to date: `cargo test -p functions --test web_api_report generate_web_standards_report -- --nocapture` produces no diff in `docs/reports/web_standards_api_report.md`
...
The file `docs/reports/web_standards_api_report.md` is auto-generated by a test. Do not edit it manually. It is regenerated by running:
```bash
